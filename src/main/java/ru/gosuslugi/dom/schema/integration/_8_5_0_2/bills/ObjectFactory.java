 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_5_0_2.bills package. 
...
public class ObjectFactory {
    ...
    private final static QName _PaymentPeriodStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills/", "PaymentPeriodStatus");
    private final static QName _ServiceCharge_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills/", "ServiceCharge");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_5_0_2.bills
     * 
     */
    ...
    /**
     * Create an instance of {@link ServicePDType.Consumption }
     * 
     */
    public ServicePDType.Consumption createServicePDTypeConsumption() {
        return new ServicePDType.Consumption();
    }
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_2.bills.PaymentRecalculation }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_2.bills.PaymentRecalculation createPaymentRecalculation() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_2.bills.PaymentRecalculation();
    }
    ...
    /**
     * Create an instance of {@link ServicePDType.Consumption.Volume }
     * 
     */
    public ServicePDType.Consumption.Volume createServicePDTypeConsumptionVolume() {
        return new ServicePDType.Consumption.Volume();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills/", name = "PaymentPeriodStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills/", name = "ServiceCharge")
