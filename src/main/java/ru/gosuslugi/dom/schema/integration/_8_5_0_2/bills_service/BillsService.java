 ...
 * 
 */
@WebServiceClient(name = "BillsService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-bills-service/services/Bills?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BILLSSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills-service/", "BillsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://54.76.42.99:60045/ext-bus-bills-service/services/Bills");
    ...
    public BillsPortsType getBillsPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills-service/", "BillsPort"), BillsPortsType.class);
    }
    ...
    public BillsPortsType getBillsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/bills-service/", "BillsPort"), BillsPortsType.class, features);
    }
