 ...
 * 
 */
@WebService(name = "DeviceMeteringPortTypes", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/device-metering-service/")
...
public interface DeviceMeteringPortTypes {
    ...
    public ImportResult importMeteringDeviceValues(
        @WebParam(name = "importMeteringDeviceValuesRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/device-metering/", partName = "importMeteringDeviceValuesRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_2.device_metering.ExportMeteringDeviceHistoryResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportMeteringDeviceHistory")
    @WebResult(name = "exportMeteringDeviceHistoryResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/device-metering/", partName = "exportMeteringDeviceHistoryResult")
    public ExportMeteringDeviceHistoryResult exportMeteringDeviceHistory(
        @WebParam(name = "exportMeteringDeviceHistoryRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/device-metering/", partName = "exportMeteringDeviceHistoryRequest")
