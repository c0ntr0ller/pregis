...
import ru.gosuslugi.dom.schema.integration._8_5_0_2.disclosure.GetStateResult;
 ...
 * 
 */
@WebService(name = "DisclosurePortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/disclosure-service-async/")
...
public interface DisclosurePortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_2.disclosure.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/disclosure/", partName = "getStateResult")
    ...
    public AckRequest importDisclosure(
        @WebParam(name = "importDisclosureRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/disclosure/", partName = "importDisclosureRequest")
