 ...
 * 
 */
@WebServiceClient(name = "FASServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/fas-service-async/", wsdlLocation = "file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-fas-service-async-8.5.0.2.wsdl")
    ...
    extends Service
{
    ...
    private final static QName FASSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/fas-service-async/", "FASServiceAsync");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-fas-service-async-8.5.0.2.wsdl");
    ...
    public FASPortsTypeAsync getFASPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/fas-service-async/", "FASPortAsync"), FASPortsTypeAsync.class);
    }
    ...
    public FASPortsTypeAsync getFASPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/fas-service-async/", "FASPortAsync"), FASPortsTypeAsync.class, features);
    }
