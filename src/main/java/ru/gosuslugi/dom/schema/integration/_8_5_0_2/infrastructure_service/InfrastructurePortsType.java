 ...
 * 
 */
@WebService(name = "InfrastructurePortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/infrastructure-service/")
...
public interface InfrastructurePortsType {
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/", partName = "importOKIResult")
    public ImportResult importOKI(
        @WebParam(name = "importOKIRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/infrastructure/", partName = "importOKIRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_2.infrastructure.ExportOKIResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportOKI")
    @WebResult(name = "exportOKIResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/infrastructure/", partName = "exportOKIResult")
    public ExportOKIResult exportOKI(
        @WebParam(name = "exportOKIRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/infrastructure/", partName = "exportOKIRequest")
