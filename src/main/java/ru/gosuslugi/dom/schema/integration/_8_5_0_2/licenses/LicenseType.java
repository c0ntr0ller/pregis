...
import ru.gosuslugi.dom.schema.integration._8_5_0.LegalType;
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}LegalType">
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="RegionFIASGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}GUIDType"/>
 *         &lt;element name="LicensableTypeOfActivity" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}LongTextType"/>
 *         &lt;element name="AdditionalInformation" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}LongTextType" minOccurs="0"/>
 *         &lt;element name="LicenseOrganization" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/licenses/}LicenseOrganizationType"/>
 *         &lt;element name="AccompanyingDocument" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/licenses/}AccompanyingDocumentType">
 *                 &lt;sequence>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="House" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/licenses/}HouseType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_5_0_2.licenses.GetStateResult.License.class,
    ru.gosuslugi.dom.schema.integration._8_5_0_2.licenses.ExportLicenseResult.License.class
})
