    ...
    extends Service
{
    ...
    private final static QName NSISERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/nsi-service/", "NsiService");
    ...
    public NsiPortsType getNsiPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/nsi-service/", "NsiPort"), NsiPortsType.class);
    }
