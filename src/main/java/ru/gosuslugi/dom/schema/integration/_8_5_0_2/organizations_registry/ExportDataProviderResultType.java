 ...
 *       &lt;sequence>
 *         &lt;element name="DataProviderGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}GUIDType"/>
 *         &lt;element name="IsActual" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.5.0.2/}RegOrg"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ExportDataProviderResultType {
    ...
    @XmlElement(name = "RegOrg", namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/", required = true)
