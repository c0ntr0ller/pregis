 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_5_0_2.payment package. 
...
public class ObjectFactory {
    ...
    private final static QName _AccountID_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/payment/", "AccountID");
    private final static QName _OrderID_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/payment/", "OrderID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_5_0_2.payment
     * 
     */
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType createNotificationOfOrderExecutionType() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType();
    }
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.SupplierInfo }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.SupplierInfo createNotificationOfOrderExecutionTypeSupplierInfo() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.SupplierInfo();
    }

    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.RecipientInfo }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.RecipientInfo createNotificationOfOrderExecutionTypeRecipientInfo() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.RecipientInfo();
    }

    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.OrderInfo }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.OrderInfo createNotificationOfOrderExecutionTypeOrderInfo() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_2.payment.NotificationOfOrderExecutionType.OrderInfo();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/payment/", name = "AccountID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/payment/", name = "OrderID")
