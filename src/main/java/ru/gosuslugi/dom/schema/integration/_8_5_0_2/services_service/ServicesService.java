 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.2/services-service/", wsdlLocation = "file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-services-service-8.5.0.2.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/services-service/", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-services-service-8.5.0.2.wsdl");
    ...
    public ServicesPortsType getDefaultPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/services-service/", "defaultPort"), ServicesPortsType.class);
    }
    ...
    public ServicesPortsType getDefaultPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.2/services-service/", "defaultPort"), ServicesPortsType.class, features);
    }
