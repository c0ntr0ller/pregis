 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_5_0_4.bills package. 
...
public class ObjectFactory {
    ...
    private final static QName _ServiceCharge_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.4/bills/", "ServiceCharge");
    private final static QName _PaymentPeriodStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.4/bills/", "PaymentPeriodStatus");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_5_0_4.bills
     * 
     */
    ...
    /**
     * Create an instance of {@link PDServiceChargeType.AdditionalServiceExt }
     * 
     */
    public PDServiceChargeType.AdditionalServiceExt createPDServiceChargeTypeAdditionalServiceExt() {
        return new PDServiceChargeType.AdditionalServiceExt();
    }

    /**
     * Create an instance of {@link PDServiceChargeType.AdditionalServiceExt.TechService }
     * 
     */
    public PDServiceChargeType.AdditionalServiceExt.TechService createPDServiceChargeTypeAdditionalServiceExtTechService() {
        return new PDServiceChargeType.AdditionalServiceExt.TechService();
    }

    /**
     * Create an instance of {@link PDServiceChargeType.AdditionalServiceExt.TechService.Consumption }
     * 
     */
    public PDServiceChargeType.AdditionalServiceExt.TechService.Consumption createPDServiceChargeTypeAdditionalServiceExtTechServiceConsumption() {
        return new PDServiceChargeType.AdditionalServiceExt.TechService.Consumption();
    }
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_5_0_4.bills.PaymentRecalculation }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_5_0_4.bills.PaymentRecalculation createPaymentRecalculation() {
        return new ru.gosuslugi.dom.schema.integration._8_5_0_4.bills.PaymentRecalculation();
    }
    ...
    /**
     * Create an instance of {@link PDServiceChargeType.AdditionalServiceExt.TechService.Consumption.Volume }
     * 
     */
    public PDServiceChargeType.AdditionalServiceExt.TechService.Consumption.Volume createPDServiceChargeTypeAdditionalServiceExtTechServiceConsumptionVolume() {
        return new PDServiceChargeType.AdditionalServiceExt.TechService.Consumption.Volume();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/bills/", name = "ServiceCharge")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/bills/", name = "PaymentPeriodStatus")
