 ...
 *       &lt;sequence>
 *         &lt;element name="BasicCharacteristicts" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}HouseBasicUpdateOMSType"/>
 *         &lt;element name="BuiltUpArea" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}BuiltUpAreaType" minOccurs="0"/>
 *         &lt;element name="UndergroundFloorCount" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}FloorType" minOccurs="0"/>
 ...
 *         &lt;element name="NonResidentialSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}NonResidentialSquareType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_5_0_4.house_management.ImportHouseOMSRequest.ApartmentHouse.ApartmentHouseToUpdate.class
})
