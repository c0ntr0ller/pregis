 ...
 *         &lt;element name="TotalSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}TotalSquareType"/>
 *         &lt;element name="State" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}nsiRef"/>
 ...
 *         &lt;element name="BuildingYear" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}YearType"/>
 *         &lt;element name="UsedYear" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}UsedYearType"/>
 *         &lt;element name="TotalWear">
 *           &lt;simpleType>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="FloorCount" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}FloorType"/>
 ...
 *         &lt;element name="OlsonTZ" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}nsiRef"/>
 *         &lt;element name="ResidentialSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/house-management/}ResidentialSquareType"/>
    ...
    extends GKNType
{
     ...
     * @return
     *     possible object is
     *     {@link HouseBasicUOType.Energy }
     *     
     */
    public HouseBasicUOType.Energy getEnergy() {
        return energy;
    }
     ...
     *     
     */
    public void setEnergy(HouseBasicUOType.Energy value) {
        this.energy = value;
    }
