...
package ru.gosuslugi.dom.schema.integration._8_5_0_4.licenses_service;
 ...
 * 
 */
@WebService(name = "LicensePortsTypes", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/licenses-service/")
...
public interface LicensePortsTypes {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_4.licenses.ExportLicenseResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportLicense")
    @WebResult(name = "exportLicenseResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/licenses/", partName = "exportLicenseResult")
    public ExportLicenseResult exportLicense(
        @WebParam(name = "exportLicenseRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/licenses/", partName = "exporttLicenseRequestType")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_4.licenses.ExportDisqualifiedPersonResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportDisqualifiedPerson")
    @WebResult(name = "exportDisqualifiedPersonResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/licenses/", partName = "exportDisqualifiedPersonResultType")
    public ExportDisqualifiedPersonResult exportDisqualifiedPerson(
        @WebParam(name = "exportDisqualifiedPersonRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/licenses/", partName = "exportDisqualifiedPersonRequestType")
