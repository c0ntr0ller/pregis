 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi/}NsiElementFieldType">
 *       &lt;sequence>
 ...
 *                 &lt;sequence>
 *                   &lt;element name="NsiItemRegistryNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi/}NsiItemRegistryNumberType"/>
 *                   &lt;element name="Ref" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}nsiRef"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends NsiElementFieldType
{
    ...
    public static class NsiRef {
        ...
        protected ru.gosuslugi.dom.schema.integration._8_5_0.NsiRef ref;
         ...
         * @return
         *     possible object is
         *     {@link ru.gosuslugi.dom.schema.integration._8_5_0.NsiRef }
         *     
         */
        public ru.gosuslugi.dom.schema.integration._8_5_0.NsiRef getRef() {
            return ref;
        }
         ...
         *     
         */
        public void setRef(ru.gosuslugi.dom.schema.integration._8_5_0.NsiRef value) {
            this.ref = value;
        }
