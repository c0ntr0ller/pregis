...
/**
 * Асинхронный сервис получения данных НСИ
 * 
 ...
 * 
 */
@WebServiceClient(name = "NsiServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi-service-async/", wsdlLocation = "file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-bills-service-8.5.0.4.wsdl")
    ...
    extends Service
{
    ...
    private final static QName NSISERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi-service-async/", "NsiServiceAsync");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-bills-service-8.5.0.4.wsdl");
    ...
    public NsiPortsTypeAsync getNsiPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi-service-async/", "NsiPortAsync"), NsiPortsTypeAsync.class);
    }
    ...
    public NsiPortsTypeAsync getNsiPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.5.0.4/nsi-service-async/", "NsiPortAsync"), NsiPortsTypeAsync.class, features);
    }
