 ...
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}PaymentDocumentNumber"/>
 *         &lt;choice>
 *           &lt;element name="HSType" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}GUIDType"/>
 *           &lt;element name="MSType" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}GUIDType"/>
 *           &lt;element name="ASType" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}GUIDType"/>
 *         &lt;/choice>
 *         &lt;element name="Amount">
 *           &lt;simpleType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_5_0_4.payment.ExportNotificationsOfOrderExecutionResultType.NotificationOfOrderExecutionWithStatus.AcknowledgmentRequestsList.AcknowledgmentRequest.class,
    ru.gosuslugi.dom.schema.integration._8_5_0_4.payment.ImportAcknowledgmentRequest.AcknowledgmentRequestInfo.class
})
public class AcknowledgmentRequestInfoType {

    @XmlElement(name = "OrderID", required = true)
    protected String orderID;
    @XmlElement(name = "PaymentDocumentNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/", required = true)
