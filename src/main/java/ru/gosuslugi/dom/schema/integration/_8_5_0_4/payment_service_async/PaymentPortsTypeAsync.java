...
package ru.gosuslugi.dom.schema.integration._8_5_0_4.payment_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_5_0_4.payment.GetStateResult;
 ...
 * 
 */
@WebService(name = "PaymentPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment-service-async/")
...
public interface PaymentPortsTypeAsync {
    ...
    public AckRequest importNotificationsOfOrderExecution(
        @WebParam(name = "importNotificationsOfOrderExecutionRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "importNotificationsOfOrderExecutionRequest")
    ...
    public AckRequest importNotificationsOfOrderExecutionCancellation(
        @WebParam(name = "importNotificationsOfOrderExecutionCancellationRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "importNotificationsOfOrderExecutionCancellationRequest")
    ...
    public AckRequest exportNotificationsOfOrderExecution(
        @WebParam(name = "exportNotificationsOfOrderExecutionRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "exportNotificationsOfOrderExecutionRequest")
    ...
    public AckRequest importAcknowledgment(
        @WebParam(name = "importAcknowledgmentRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "importAcknowledgmentRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_5_0_4.payment.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "getRequestStateResult")
    public GetStateResult getState(
        @WebParam(name = "getStateRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/", partName = "getRequestState")
    ...
    public AckRequest exportPaymentDocumentDetails(
        @WebParam(name = "exportPaymentDocumentDetailsRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/payment/", partName = "exportPaymentDocumentDetailsRequest")
