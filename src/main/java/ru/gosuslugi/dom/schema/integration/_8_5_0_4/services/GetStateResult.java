 ...
 *         &lt;element name="ExportHMServicesTarifsResult" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/}exportHMServicesTarifsResultType" maxOccurs="unbounded"/>
 *         &lt;element name="ExportMSRSOResult" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/}exportMSRSOResultType" maxOccurs="unbounded"/>
 *         &lt;element name="ExportCompletedWorksResult" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/}exportCompletedWorksResultType" maxOccurs="unbounded"/>
 *         &lt;element name="ExportWorkingListResult" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/}exportWorkingListResultType" maxOccurs="unbounded"/>
 *         &lt;element name="ExportWorkingPlanResult" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/}exportWorkingPlanResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
