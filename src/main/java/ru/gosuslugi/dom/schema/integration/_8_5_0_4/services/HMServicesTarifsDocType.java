 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}DocumentPortalType">
 *       &lt;sequence>
 ...
 *         &lt;element name="CancelServicesTarifDocGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}GUIDType" minOccurs="0"/>
 ...
 *                   &lt;sequence>
 *                     &lt;element name="MServiceType" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}nsiRef" maxOccurs="unbounded"/>
 *                     &lt;element name="Municipalities" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}OKTMORefType" minOccurs="0"/>
 *                     &lt;element name="RSOOrganizationGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}RegOrgVersionType" maxOccurs="unbounded"/>
 ...
 *           &lt;sequence>
 *             &lt;element name="OKTMOs" type="{http://dom.gosuslugi.ru/schema/integration/8.5.0.4/}OKTMORefType" maxOccurs="unbounded"/>
...
@XmlSeeAlso({
    ...
    ru.gosuslugi.dom.schema.integration._8_5_0_4.services.ImportHMServicesTarifsRequest.HMServicesTarifsDoc.class
})
    ...
    extends DocumentPortalType
{
    ...
    public static class KU {
            ...
            extends NsiRef
        {
            ...
            @XmlElementRef(name = "Name", namespace = "http://dom.gosuslugi.ru/schema/integration/8.5.0.4/services/", type = JAXBElement.class, required = false)
             ...
             * line 1425 of file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-services-types-8.5.0.4.xsd
             * line 464 of file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-basetypes-8.5.0.4.xsd
             * <p>
