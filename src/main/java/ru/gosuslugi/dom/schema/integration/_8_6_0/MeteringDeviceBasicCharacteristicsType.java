...
/**
 * Основные характеристики прибора учета.
 * 
 ...
 *         &lt;element name="ManualModeMetering" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="VerificationCharacteristics">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="FirstVerificationDate" type="{http://www.w3.org/2001/XMLSchema}date"/>
 *                   &lt;element name="VerificationInterval" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;choice>
 *           &lt;element name="CollectiveDevice" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *           &lt;element name="ResidentialPremiseDevice">
 *             &lt;complexType>
 *               &lt;complexContent>
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence>
 *                     &lt;element name="PremiseGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType"/>
 *                     &lt;element name="AccountGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" maxOccurs="unbounded"/>
 *                   &lt;/sequence>
 *                 &lt;/restriction>
 *               &lt;/complexContent>
 *             &lt;/complexType>
 ...
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence>
 *                     &lt;element name="LivingRoomGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" maxOccurs="unbounded"/>
 *                     &lt;element name="AccountGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" maxOccurs="unbounded"/>
 *                   &lt;/sequence>
 *                 &lt;/restriction>
 *               &lt;/complexContent>
...
public class MeteringDeviceBasicCharacteristicsType {
    ...
    @XmlElement(name = "VerificationCharacteristics", required = true)
    protected MeteringDeviceBasicCharacteristicsType.VerificationCharacteristics verificationCharacteristics;
    ...
    /**
     * Gets the value of the verificationCharacteristics property.
     * 
     * @return
     *     possible object is
     *     {@link MeteringDeviceBasicCharacteristicsType.VerificationCharacteristics }
     *     
     */
    public MeteringDeviceBasicCharacteristicsType.VerificationCharacteristics getVerificationCharacteristics() {
        return verificationCharacteristics;
    }

    /**
     * Sets the value of the verificationCharacteristics property.
     * 
     * @param value
     *     allowed object is
     *     {@link MeteringDeviceBasicCharacteristicsType.VerificationCharacteristics }
     *     
     */
    public void setVerificationCharacteristics(MeteringDeviceBasicCharacteristicsType.VerificationCharacteristics value) {
        this.verificationCharacteristics = value;
    }
    ...
    public static class VerificationCharacteristics {

        @XmlElement(name = "FirstVerificationDate", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar firstVerificationDate;
        @XmlElement(name = "VerificationInterval", required = true)
