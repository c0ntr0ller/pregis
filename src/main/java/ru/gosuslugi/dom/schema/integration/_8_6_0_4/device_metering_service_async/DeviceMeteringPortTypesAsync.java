...
package ru.gosuslugi.dom.schema.integration._8_6_0_4.device_metering_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_4.device_metering.GetStateResult;
 ...
 * 
 */
@WebService(name = "DeviceMeteringPortTypesAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/device-metering-service-async/")
...
public interface DeviceMeteringPortTypesAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.device_metering.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/device-metering/", partName = "getStateResult")
