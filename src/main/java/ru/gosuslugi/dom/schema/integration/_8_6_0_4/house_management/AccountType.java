 ...
 *         &lt;/choice>
 *         &lt;choice>
 *           &lt;element name="OwnerInd" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}IndType"/>
 *           &lt;element name="OwnerOrg" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}RegOrgVersionType"/>
 *           &lt;element name="RenterInd" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}IndType"/>
 *           &lt;element name="RenterOrg" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}RegOrgVersionType"/>
 *         &lt;/choice>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="TotalSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}PremisesAreaType"/>
 *         &lt;element name="ResidentialSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}PremisesAreaType" minOccurs="0"/>
 *         &lt;element name="HeatedArea" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}PremisesAreaType" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/house-management/}ShareGUID" maxOccurs="unbounded"/>
 *         &lt;element name="Closed" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/house-management/}ClosedAccountAttributesType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ...
    ru.gosuslugi.dom.schema.integration._8_6_0_4.house_management.ImportAccountRequest.Account.class
})
