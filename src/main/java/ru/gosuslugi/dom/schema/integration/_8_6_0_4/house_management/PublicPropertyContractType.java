 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="Organization" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}RegOrgType"/>
 *           &lt;element name="Entrepreneur" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}IndType"/>
 *         &lt;/choice>
 *         &lt;element name="FIASHouseGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType"/>
 *         &lt;element name="ContractNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/house-management/}ContractNumberType"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="Payment" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}SmallMoneyPositiveType" minOccurs="0"/>
 ...
 *                             &lt;element name="TrustDocAttachment" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}AttachmentType" maxOccurs="unbounded"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="ProtocolGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" maxOccurs="unbounded"/>
 *                 &lt;/choice>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="AgreementPaymentVersionGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" minOccurs="0"/>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="Bill" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}SmallMoneyPositiveType"/>
 *                             &lt;element name="Debt" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}SmallMoneyType"/>
 *                             &lt;element name="Paid" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}SmallMoneyPositiveType"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="DelAgreementPayment">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="AgreementPaymentVersionGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 ...
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/house-management/}AnnulmentType">
 *                           &lt;sequence>
 *                             &lt;element name="AgreementPaymentVersionGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType"/>
 *                           &lt;/sequence>
 *                         &lt;/extension>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_6_0_4.house_management.ExportStatusPublicPropertyContractResultType.PublicPropertyContract.class
})
public class PublicPropertyContractType {
    ...
    public static class AgreementPayment {
        ...
        protected PublicPropertyContractType.AgreementPayment.DelAgreementPayment delAgreementPayment;
         ...
         * @return
         *     possible object is
         *     {@link PublicPropertyContractType.AgreementPayment.DelAgreementPayment }
         *     
         */
        public PublicPropertyContractType.AgreementPayment.DelAgreementPayment getDelAgreementPayment() {
            return delAgreementPayment;
        }

        /**
         * Sets the value of the delAgreementPayment property.
         * 
         * @param value
         *     allowed object is
         *     {@link PublicPropertyContractType.AgreementPayment.DelAgreementPayment }
         *     
         */
        public void setDelAgreementPayment(PublicPropertyContractType.AgreementPayment.DelAgreementPayment value) {
            this.delAgreementPayment = value;
        }
