 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/house-management/}PremisesBasicUpdateOMSType">
 *       &lt;sequence>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="PremisesCharacteristic" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}nsiRef" minOccurs="0"/>
 *         &lt;element name="RoomsNum" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}nsiRef" minOccurs="0"/>
 *         &lt;element name="GrossArea" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}PremisesAreaType" minOccurs="0"/>
 *         &lt;element name="TotalArea" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}PremisesAreaType" minOccurs="0"/>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_6_0_4.house_management.ImportHouseOMSRequest.ApartmentHouse.ResidentialPremises.ResidentialPremisesToUpdate.class
})
