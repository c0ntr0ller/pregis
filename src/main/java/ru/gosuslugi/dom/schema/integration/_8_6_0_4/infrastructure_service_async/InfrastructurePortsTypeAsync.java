...
package ru.gosuslugi.dom.schema.integration._8_6_0_4.infrastructure_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_4.infrastructure.GetStateResult;
 ...
 * 
 */
@WebService(name = "InfrastructurePortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/infrastructure-service-async/")
...
public interface InfrastructurePortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.infrastructure.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/infrastructure/", partName = "getStateResult")
