...
package ru.gosuslugi.dom.schema.integration._8_6_0_4.nsi;
 ...
 *           &lt;element name="ElementGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}GUIDType" minOccurs="0"/>
 *         &lt;/sequence>
 *         &lt;element name="WorkName" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}String500Type"/>
 *         &lt;element name="ServiceTypeRef" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}nsiRef"/>
 *         &lt;element name="RequiredServiceRef" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}nsiRef" maxOccurs="unbounded"/>
 *         &lt;choice>
 *           &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}OKEI"/>
 *           &lt;element name="StringDimensionUnit" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}String100Type"/>
 *         &lt;/choice>
 *         &lt;element name="ImportOrganizationWork" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi/}ImportOrganizationWorkType" maxOccurs="1000" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ImportOrganizationWorkType {
    ...
    @XmlElement(name = "OKEI", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/")
