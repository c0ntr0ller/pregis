 ...
 * 
 */
@WebServiceClient(name = "NsiService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-nsi-common-service/services/NsiCommon")
    ...
    extends Service
{
    ...
    private final static QName NSISERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service/", "NsiService");
    ...
    public NsiPortsType getNsiPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service/", "NsiPort"), NsiPortsType.class);
    }
    ...
    public NsiPortsType getNsiPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service/", "NsiPort"), NsiPortsType.class, features);
    }
