...
import ru.gosuslugi.dom.schema.integration._8_6_0_4.nsi_common.GetStateResult;
 ...
 * 
 */
@WebService(name = "NsiPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service-async/")
...
public interface NsiPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.nsi_common.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common/", partName = "getStateResult")
