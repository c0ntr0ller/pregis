 ...
 * 
 */
@WebServiceClient(name = "NsiServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-nsi-common-service/services/NsiCommonAsync")
    ...
    extends Service
{
    ...
    private final static QName NSISERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service-async/", "NsiServiceAsync");
    ...
    public NsiPortsTypeAsync getNsiPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service-async/", "NsiPortAsync"), NsiPortsTypeAsync.class);
    }
    ...
    public NsiPortsTypeAsync getNsiPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/nsi-common-service-async/", "NsiPortAsync"), NsiPortsTypeAsync.class, features);
    }
