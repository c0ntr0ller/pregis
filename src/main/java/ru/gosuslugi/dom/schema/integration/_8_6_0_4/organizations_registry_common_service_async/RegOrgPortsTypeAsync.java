...
package ru.gosuslugi.dom.schema.integration._8_6_0_4.organizations_registry_common_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_4.organizations_registry_common.GetStateResult;
 ...
 * 
 */
@WebService(name = "RegOrgPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-common-service-async/")
...
public interface RegOrgPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.organizations_registry_common.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-common/", partName = "getStateResult")
    ...
    public AckRequest exportDataProvider(
        @WebParam(name = "exportDataProviderRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-common/", partName = "exportDataProviderRequest")
