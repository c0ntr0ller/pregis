 ...
 * 
 */
@WebServiceClient(name = "RegOrgServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-org-registry-service/services/OrgRegistryAsync")
    ...
    extends Service
{
    ...
    private final static QName REGORGSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-service-async/", "RegOrgServiceAsync");
    ...
    public RegOrgPortsTypeAsync getRegOrgAsyncPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-service-async/", "RegOrgAsyncPort"), RegOrgPortsTypeAsync.class);
    }
    ...
    public RegOrgPortsTypeAsync getRegOrgAsyncPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/organizations-registry-service-async/", "RegOrgAsyncPort"), RegOrgPortsTypeAsync.class, features);
    }
