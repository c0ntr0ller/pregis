 ...
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}AccountNumber"/>
 ...
 *         &lt;/choice>
 *         &lt;element name="Reminder" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/}MoneyPositiveType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PaymentDocumentDetailsType {
    ...
    @XmlElement(name = "PaymentDocumentNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", required = true)
    protected String paymentDocumentNumber;
    @XmlElement(name = "AccountNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", required = true)
