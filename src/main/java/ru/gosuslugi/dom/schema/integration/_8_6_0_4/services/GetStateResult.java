 ...
 *         &lt;element name="exportHMServicesTarifsResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/}exportHMServicesTarifsResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportMSRSOResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/}exportMSRSOResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportCompletedWorksResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/}exportCompletedWorksResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportWorkingListResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/}exportWorkingListResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportWorkingPlanResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/}exportWorkingPlanResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
