 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_6_0_4.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _WorkListStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", "WorkListStatus");
    private final static QName _HMServicesTarifsDocTypeKUMServiceTypeName_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", "Name");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_6_0_4.services
     * 
     */
    ...
    /**
     * Create an instance of {@link ImportMSRSORequest }
     * 
     */
    public ImportMSRSORequest createImportMSRSORequest() {
        return new ImportMSRSORequest();
    }
    ...
    /**
     * Create an instance of {@link ImportHMServicesTarifsRequest }
     * 
     */
    public ImportHMServicesTarifsRequest createImportHMServicesTarifsRequest() {
        return new ImportHMServicesTarifsRequest();
    }
    ...
    /**
     * Create an instance of {@link ExportMSRSOResultType }
     * 
     */
    public ExportMSRSOResultType createExportMSRSOResultType() {
        return new ExportMSRSOResultType();
    }
    ...
    /**
     * Create an instance of {@link ImportMSRSORequest.MSRSO }
     * 
     */
    public ImportMSRSORequest.MSRSO createImportMSRSORequestMSRSO() {
        return new ImportMSRSORequest.MSRSO();
    }
    ...
    /**
     * Create an instance of {@link ExportMSRSORequest }
     * 
     */
    public ExportMSRSORequest createExportMSRSORequest() {
        return new ExportMSRSORequest();
    }
    ...
    /**
     * Create an instance of {@link ExportMSRSOResult }
     * 
     */
    public ExportMSRSOResult createExportMSRSOResult() {
        return new ExportMSRSOResult();
    }

    /**
     * Create an instance of {@link ImportHMServicesTarifsRequest.HMServicesTarifsDoc }
     * 
     */
    public ImportHMServicesTarifsRequest.HMServicesTarifsDoc createImportHMServicesTarifsRequestHMServicesTarifsDoc() {
        return new ImportHMServicesTarifsRequest.HMServicesTarifsDoc();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", name = "WorkListStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", name = "Name", scope = HMServicesTarifsDocType.KU.MServiceType.class)
