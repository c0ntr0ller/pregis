...
package ru.gosuslugi.dom.schema.integration._8_6_0_4.services_service;
 ...
 * 
 */
@WebService(name = "ServicesPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services-service/")
...
public interface ServicesPortsType {
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", partName = "importHMServicesTarifsDataResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.services.ExportHMServicesTarifsResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportHMServicesTarifs")
    @WebResult(name = "exportHMServicesTarifsResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportHMServicesTarifsDataResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", partName = "importMSRSODataResult")
    public ImportResult importMSRSO(
        @WebParam(name = "importMSRSORequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "importMSRSODataRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.services.ExportMSRSOResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportMSRSO")
    @WebResult(name = "exportMSRSOResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportMSRSODataResult")
    public ExportMSRSOResult exportMSRSO(
        @WebParam(name = "exportMSRSORequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportMSRSODataRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.services.ExportWorkingListResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingList")
    @WebResult(name = "exportWorkingListResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportWorkingListResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", partName = "importWorkingListResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", partName = "importWorkingPlanResult")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.services.ExportWorkingPlanResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingPlan")
    @WebResult(name = "exportWorkingPlanResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportWorkingPlanResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/", partName = "importCompletedWorksResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_4.services.ExportCompletedWorksResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportCompletedWorks")
    @WebResult(name = "exportCompletedWorksResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.4/services/", partName = "exportCompletedWorksResult")
