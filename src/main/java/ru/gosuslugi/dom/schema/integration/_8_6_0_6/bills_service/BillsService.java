 ...
 * 
 */
@WebServiceClient(name = "BillsService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/bills-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-bills-service/services/Bills")
    ...
    extends Service
{
    ...
    private final static QName BILLSSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/bills-service/", "BillsService");
    ...
    public BillsPortsType getBillsPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/bills-service/", "BillsPort"), BillsPortsType.class);
    }
    ...
    public BillsPortsType getBillsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/bills-service/", "BillsPort"), BillsPortsType.class, features);
    }
