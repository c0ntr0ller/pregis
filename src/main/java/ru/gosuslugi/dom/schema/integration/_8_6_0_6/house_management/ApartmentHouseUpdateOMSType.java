 ...
 *       &lt;sequence>
 *         &lt;element name="BasicCharacteristicts" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}HouseBasicUpdateOMSType"/>
 *         &lt;element name="BuiltUpArea" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}BuiltUpAreaType" minOccurs="0"/>
 *         &lt;element name="UndergroundFloorCount" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}FloorType" minOccurs="0"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="OverhaulYear" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}YearType" minOccurs="0"/>
 *         &lt;element name="OverhaulFormingKind" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}nsiRef" minOccurs="0"/>
 *         &lt;element name="NonResidentialSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}NonResidentialSquareType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_6_0_6.house_management.ImportHouseOMSRequest.ApartmentHouse.ApartmentHouseToUpdate.class
})
