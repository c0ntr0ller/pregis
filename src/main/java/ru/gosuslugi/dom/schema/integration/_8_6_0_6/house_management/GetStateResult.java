 ...
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}ImportResult" maxOccurs="unbounded"/>
 *         &lt;element name="exportHouseResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportHouseResultType"/>
 *         &lt;element name="exportMeteringDeviceDataResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportMeteringDeviceDataResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportShareEncbrDataResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportShareEncbrDataResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportStatusCAChResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportStatusCAChResultType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="exportCAChResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportCAChResultType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="exportStatusPublicPropertyContractResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportStatusPublicPropertyContractResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportAccountResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportAccountResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportVotingProtocolResult" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/}exportVotingProtocolResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
