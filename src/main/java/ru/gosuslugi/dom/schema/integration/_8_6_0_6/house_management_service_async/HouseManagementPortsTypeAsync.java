...
package ru.gosuslugi.dom.schema.integration._8_6_0_6.house_management_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_6.house_management.GetStateResult;
 ...
 * 
 */
@WebService(name = "HouseManagementPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management-service-async/")
...
public interface HouseManagementPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_6.house_management.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/", partName = "getStateResult")
    ...
    public AckRequest exportHouseData(
        @WebParam(name = "exportHouseRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/", partName = "exportHouseRequest")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", partName = "AckResult")
    public AckRequest importAccountData(
        @WebParam(name = "importAccountRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/", partName = "importAccountData")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", partName = "AckRequestr")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", partName = "tns:exportCAChDataResult")
    public AckRequest exportCAChData(
        @WebParam(name = "exportCAChRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management/", partName = "tns:exportCAChDataRequest")
