 ...
 * 
 */
@WebServiceClient(name = "HouseManagementServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-home-management-service/services/HomeManagementAsync")
    ...
    extends Service
{
    ...
    private final static QName HOUSEMANAGEMENTSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management-service-async/", "HouseManagementServiceAsync");
    ...
    public HouseManagementPortsTypeAsync getHouseManagementPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management-service-async/", "HouseManagementPortAsync"), HouseManagementPortsTypeAsync.class);
    }
    ...
    public HouseManagementPortsTypeAsync getHouseManagementPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/house-management-service-async/", "HouseManagementPortAsync"), HouseManagementPortsTypeAsync.class, features);
    }
