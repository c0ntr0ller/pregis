 ...
 * 
 */
@WebServiceClient(name = "LicenseService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/licenses-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-licenses-service/services/Licenses")
    ...
    extends Service
{
    ...
    private final static QName LICENSESERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/licenses-service/", "LicenseService");
    ...
    public LicensePortsTypes getLicensesPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/licenses-service/", "LicensesPort"), LicensePortsTypes.class);
    }
    ...
    public LicensePortsTypes getLicensesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.6.0.6/licenses-service/", "LicensesPort"), LicensePortsTypes.class, features);
    }
