 ...
 *         &lt;/choice>
 *         &lt;element name="Reminder" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}MoneyPositiveType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PaymentDocumentDetailsType {
    ...
    @XmlElement(name = "PaymentDocumentNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", required = true)
    protected String paymentDocumentNumber;
    @XmlElement(name = "AccountNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", required = true)
