...
package ru.gosuslugi.dom.schema.integration._8_6_0_6.payment_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_6.payment.GetStateResult;
 ...
 * 
 */
@WebService(name = "PaymentPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/payment-service-async/")
...
public interface PaymentPortsTypeAsync {
    ...
    public AckRequest importNotificationsOfOrderExecution(
        @WebParam(name = "importNotificationsOfOrderExecutionRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/payment/", partName = "importNotificationsOfOrderExecutionRequest")
    ...
    public AckRequest importNotificationsOfOrderExecutionCancellation(
        @WebParam(name = "importNotificationsOfOrderExecutionCancellationRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/payment/", partName = "importNotificationsOfOrderExecutionCancellationRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_6.payment.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/payment/", partName = "getRequestStateResult")
    public GetStateResult getState(
        @WebParam(name = "getStateRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", partName = "getRequestState")
    ...
    public AckRequest exportPaymentDocumentDetails(
        @WebParam(name = "exportPaymentDocumentDetailsRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/payment/", partName = "exportPaymentDocumentDetailsRequest")
