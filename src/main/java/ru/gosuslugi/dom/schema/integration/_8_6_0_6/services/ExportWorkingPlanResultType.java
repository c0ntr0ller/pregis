 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="WorkListGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}GUIDType"/>
 *                   &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}Year"/>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="reportingPeriodGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}GUIDType"/>
 *                             &lt;element name="MonthYear">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}Month"/>
 *                                       &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}Year"/>
 *                                     &lt;/sequence>
 *                                   &lt;/restriction>
 *                                 &lt;/complexContent>
 ...
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="WorkPlanItemGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}GUIDType"/>
 *                                       &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}ModificationDate"/>
 *                                       &lt;element name="WorkGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}nsiRef"/>
 *                                       &lt;element name="workTypeGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}nsiRef" minOccurs="0"/>
 *                                       &lt;element name="sortIndex" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" minOccurs="0"/>
 *                                       &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.6.0.6/}OKEI" minOccurs="0"/>
 *                                       &lt;choice>
...
public class ExportWorkingPlanResultType {
    ...
    public static class WorkingPlan {
        ...
        @XmlElement(name = "Year", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/")
        ...
        public static class ReportingPeriod {
            ...
            public static class MonthYear {
                ...
                @XmlElement(name = "Month", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/")
                protected int month;
                @XmlElement(name = "Year", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/")
                protected short year;
            ...
            public static class WorkPlanItem {
                ...
                @XmlElement(name = "ModificationDate", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/", required = true)
                ...
                @XmlElement(name = "OKEI", namespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/")
