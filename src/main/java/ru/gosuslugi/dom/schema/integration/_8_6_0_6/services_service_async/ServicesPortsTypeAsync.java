...
package ru.gosuslugi.dom.schema.integration._8_6_0_6.services_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_6_0_6.services.GetStateResult;
 ...
 * 
 */
@WebService(name = "ServicesPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/services-service-async/")
...
public interface ServicesPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_6_0_6.services.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/services/", partName = "getStateResult")
    ...
    public AckRequest importMSRSO(
        @WebParam(name = "importMSRSORequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/services/", partName = "tns:importMSRSODataRequest")
    ...
    public AckRequest exportMSRSO(
        @WebParam(name = "exportMSRSORequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.6.0.6/services/", partName = "tns:exportMSRSORequest")
