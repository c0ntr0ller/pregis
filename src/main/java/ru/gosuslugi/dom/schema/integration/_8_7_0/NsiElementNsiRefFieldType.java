 ...
 *                   &lt;element name="Ref" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.4/}nsiRef"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends NsiElementFieldType
{
    ...
    public static class NsiRef {
        ...
        protected ru.gosuslugi.dom.schema.integration._8_7_0.NsiRef ref;
         ...
         * @return
         *     possible object is
         *     {@link ru.gosuslugi.dom.schema.integration._8_7_0.NsiRef }
         *     
         */
        public ru.gosuslugi.dom.schema.integration._8_7_0.NsiRef getRef() {
            return ref;
        }
         ...
         *     
         */
        public void setRef(ru.gosuslugi.dom.schema.integration._8_7_0.NsiRef value) {
            this.ref = value;
        }
