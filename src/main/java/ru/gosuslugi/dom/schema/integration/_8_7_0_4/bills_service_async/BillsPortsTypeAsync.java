...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.bills.GetStateResult;
 ...
 * 
 */
@WebService(name = "BillsPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/bills-service-async/")
...
public interface BillsPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.bills.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/bills/", partName = "getStateResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "openOrgPaymentPeriodResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "closeHousePaymentPeriodResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importPaymentDocumentDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "exportPaymentDocumentDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "exportOrgPeriodDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "exportNotificationsOfOrderExecutionResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importAcknowledgmentResult")
