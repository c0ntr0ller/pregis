...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.device_metering_service;
 ...
 * 
 */
@WebService(name = "DeviceMeteringPortTypes", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering-service/")
...
public interface DeviceMeteringPortTypes {
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "ImportResult")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.device_metering.ExportMeteringDeviceHistoryResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportMeteringDeviceHistory")
    @WebResult(name = "exportMeteringDeviceHistoryResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering/", partName = "exportMeteringDeviceHistoryResult")
