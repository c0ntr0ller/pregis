 ...
 * 
 */
@WebServiceClient(name = "DeviceMeteringService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-device-metering-service/services/DeviceMetering")
    ...
    extends Service
{
    ...
    private final static QName DEVICEMETERINGSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering-service/", "DeviceMeteringService");
    ...
    public DeviceMeteringPortTypes getDeviceMeteringPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering-service/", "DeviceMeteringPort"), DeviceMeteringPortTypes.class);
    }
    ...
    public DeviceMeteringPortTypes getDeviceMeteringPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/device-metering-service/", "DeviceMeteringPort"), DeviceMeteringPortTypes.class, features);
    }
