...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.disclosure.GetStateResult;
 ...
 * 
 */
@WebService(name = "DisclosurePortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/disclosure-service-async/")
...
public interface DisclosurePortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.disclosure.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/disclosure/", partName = "getStateResult")
    ...
    public AckRequest importDisclosure(
        @WebParam(name = "importDisclosureRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/disclosure/", partName = "importDisclosureRequest")
