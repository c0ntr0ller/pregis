 ...
 *                               &lt;element name="ResourseType" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas/}ResourseType" maxOccurs="unbounded"/>
 *                               &lt;element name="OKTMO" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.4/}OKTMORefType" maxOccurs="unbounded"/>
    ...
    public static class RSO {
        ...
        public static class RSOActualDATA {
            ...
            public static class Entps {
                ...
                @XmlElement(name = "OGRNIP", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", required = true)
            ...
            public static class Legal {
                ...
                @XmlElement(name = "OGRN", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", required = true)
