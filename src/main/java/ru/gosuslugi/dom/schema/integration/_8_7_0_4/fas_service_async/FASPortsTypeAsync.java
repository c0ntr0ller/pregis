...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.fas_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.fas.GetStateResult;
 ...
 * 
 */
@WebService(name = "FASPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas-service-async/")
...
public interface FASPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.fas.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas/", partName = "getStateResult")
    ...
    public AckRequest importRSO(
        @WebParam(name = "importRSORequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas/", partName = "importRSORequest")
