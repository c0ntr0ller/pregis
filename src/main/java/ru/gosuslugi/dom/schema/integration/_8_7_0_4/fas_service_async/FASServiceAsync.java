 ...
 * 
 */
@WebServiceClient(name = "FASServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-fas-service/services/FASAsync")
    ...
    extends Service
{
    ...
    private final static QName FASSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas-service-async/", "FASServiceAsync");
    ...
    public FASPortsTypeAsync getFASPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas-service-async/", "FASPortAsync"), FASPortsTypeAsync.class);
    }
    ...
    public FASPortsTypeAsync getFASPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/fas-service-async/", "FASPortAsync"), FASPortsTypeAsync.class, features);
    }
