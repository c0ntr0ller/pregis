    ...
    extends FIOType
{
    ...
    @XmlElement(name = "SNILS", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/")
    protected String snils;
    @XmlElement(name = "ID", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/")
    protected ID id;
