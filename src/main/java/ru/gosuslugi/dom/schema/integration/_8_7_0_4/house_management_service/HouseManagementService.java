 ...
 * 
 */
@WebServiceClient(name = "HouseManagementService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-home-management-service/services/HomeManagement")
    ...
    extends Service
{
    ...
    private final static QName HOUSEMANAGEMENTSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management-service/", "HouseManagementService");
    ...
    public HouseManagementPortsType getHouseManagementPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management-service/", "HouseManagementPort"), HouseManagementPortsType.class);
    }
    ...
    public HouseManagementPortsType getHouseManagementPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management-service/", "HouseManagementPort"), HouseManagementPortsType.class, features);
    }
