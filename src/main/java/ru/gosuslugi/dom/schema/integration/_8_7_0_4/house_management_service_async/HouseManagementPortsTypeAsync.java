...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.house_management_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.house_management.GetStateResult;
 ...
 * 
 */
@WebService(name = "HouseManagementPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management-service-async/")
...
public interface HouseManagementPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.house_management.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management/", partName = "getStateResult")
    ...
    public AckRequest exportHouseData(
        @WebParam(name = "exportHouseRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management/", partName = "exportHouseRequest")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "AckResult")
    public AckRequest importAccountData(
        @WebParam(name = "importAccountRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management/", partName = "importAccountData")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "AckRequestr")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "exportCAChDataResult")
    public AckRequest exportCAChData(
        @WebParam(name = "exportCAChAsyncRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/house-management/", partName = "exportCAChDataRequest")
