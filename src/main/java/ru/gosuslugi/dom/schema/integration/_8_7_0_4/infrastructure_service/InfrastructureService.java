 ...
 * 
 */
@WebServiceClient(name = "InfrastructureService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/infrastructure-service/", wsdlLocation = "file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-bills-service-8.7.0.4.wsdl")
    ...
    extends Service
{
    ...
    private final static QName INFRASTRUCTURESERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/infrastructure-service/", "InfrastructureService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/andryha/project/workspace_for_git/PreGIS/src/main/resources/wsdl/hcs-bills-service-8.7.0.4.wsdl");
    ...
    public InfrastructurePortsType getInfrastructurePort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/infrastructure-service/", "InfrastructurePort"), InfrastructurePortsType.class);
    }
    ...
    public InfrastructurePortsType getInfrastructurePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/infrastructure-service/", "InfrastructurePort"), InfrastructurePortsType.class, features);
    }
