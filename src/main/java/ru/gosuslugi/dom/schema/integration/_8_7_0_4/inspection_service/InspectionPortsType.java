 ...
 * 
 */
@WebService(name = "InspectionPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection-service/")
...
public interface InspectionPortsType {
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importInspectionPlanResult")
    public ImportResult importInspectionPlan(
        @WebParam(name = "importInspectionPlanRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "importInspectionPlanRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.inspection.ExportInspectionPlansResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportInspectionPlans")
    @WebResult(name = "exportInspectionPlansResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "exportInspectionPlansResult")
    public ExportInspectionPlansResult exportInspectionPlans(
        @WebParam(name = "exportInspectionPlansRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "exportInspectionPlansRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importExaminationsResult")
    public ImportResult importExaminations(
        @WebParam(name = "importExaminationsRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "importExaminationsRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.inspection.ExportExaminationsResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportExaminations")
    @WebResult(name = "exportExaminationsResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "exportExaminationsResult")
    public ExportExaminationsResult exportExaminations(
        @WebParam(name = "exportExaminationsRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "exportExaminationsRequest")
