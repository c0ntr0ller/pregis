...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.inspection_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.inspection.GetStateResult;
 ...
 * 
 */
@WebService(name = "InspectionPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection-service-async/")
...
public interface InspectionPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.inspection.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/inspection/", partName = "getStateResult")
