...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.licenses_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.licenses.GetStateResult;
 ...
 * 
 */
@WebService(name = "LicensePortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/licenses-service-async/")
...
public interface LicensePortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.licenses.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/licenses/", partName = "getStateResult")
