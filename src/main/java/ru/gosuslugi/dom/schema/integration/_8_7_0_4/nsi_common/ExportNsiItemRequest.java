 ...
 *       &lt;sequence>
 *         &lt;element name="RegistryNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.4/}NsiItemRegistryNumberType"/>
    ...
    extends BaseType
{
    ...
    @XmlElement(name = "ListGroup", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", required = true)
