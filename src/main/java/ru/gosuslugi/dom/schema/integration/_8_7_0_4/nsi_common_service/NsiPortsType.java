...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.nsi_common_service;
 ...
 * 
 */
@WebService(name = "NsiPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-common-service/")
...
public interface NsiPortsType {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.nsi_common.ExportNsiListResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportNsiList")
    @WebResult(name = "exportNsiListResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-common/", partName = "exportNsiListResult")
    public ExportNsiListResult exportNsiList(
        @WebParam(name = "exportNsiListRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-common/", partName = "exportNsiListRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.nsi_common.ExportNsiItemResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportNsiItem")
    @WebResult(name = "exportNsiItemResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-common/", partName = "exportNsiItemResult")
    public ExportNsiItemResult exportNsiItem(
        @WebParam(name = "exportNsiItemRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-common/", partName = "exportNsiItemRequest")
