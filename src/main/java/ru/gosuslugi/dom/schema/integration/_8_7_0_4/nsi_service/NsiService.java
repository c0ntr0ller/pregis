 ...
 * 
 */
@WebServiceClient(name = "NsiService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-nsi-service/services/Nsi")
    ...
    extends Service
{
    ...
    private final static QName NSISERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-service/", "NsiService");
    ...
    public NsiPortsType getNsiPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-service/", "NsiPort"), NsiPortsType.class);
    }
    ...
    public NsiPortsType getNsiPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/nsi-service/", "NsiPort"), NsiPortsType.class, features);
    }
