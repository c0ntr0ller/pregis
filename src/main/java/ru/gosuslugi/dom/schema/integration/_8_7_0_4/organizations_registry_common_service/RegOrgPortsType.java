...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.organizations_registry_common_service;
 ...
 * 
 */
@WebService(name = "RegOrgPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry-common-service/")
...
public interface RegOrgPortsType {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.organizations_registry_common.ExportOrgRegistryResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportOrgRegistry")
    @WebResult(name = "exportOrgRegistryResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry-common/", partName = "exportOrgRegistryResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.organizations_registry_common.ExportDataProviderResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportDataProvider")
    @WebResult(name = "exportDataProviderResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry-common/", partName = "exportDataProviderResult")
