...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.organizations_registry.GetStateResult;
 ...
 * 
 */
@WebService(name = "RegOrgPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry-service-async/")
...
public interface RegOrgPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.organizations_registry.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry/", partName = "getStateResult")
    ...
    public AckRequest importSubsidiary(
        @WebParam(name = "importSubsidiaryRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/organizations-registry/", partName = "importSubsidiaryRequest")
