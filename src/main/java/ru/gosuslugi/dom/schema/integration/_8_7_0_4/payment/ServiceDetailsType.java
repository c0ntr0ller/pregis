...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration._8_7_0_4.payment.ChargeType.Service.class
})
public class ServiceDetailsType {
    ...
    @XmlElement(name = "ServiceID", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", required = true)
