...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.services_service;
 ...
 * 
 */
@WebService(name = "ServicesPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service/")
...
public interface ServicesPortsType {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.services.ExportHMServicesTarifsResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportHMServicesTarifs")
    @WebResult(name = "exportHMServicesTarifsResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportHMServicesTarifsDataResult")
    public ExportHMServicesTarifsResult exportHMServicesTarifs(
        @WebParam(name = "exportHMServicesTarifsRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportHMServicesTarifsDataRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.services.ExportWorkingListResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingList")
    @WebResult(name = "exportWorkingListResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportWorkingListResult")
    public ExportWorkingListResult exportWorkingList(
        @WebParam(name = "exportWorkingListRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportWorkingListRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importWorkingListResult")
    public ImportResult importWorkingList(
        @WebParam(name = "importWorkingListRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "importWorkingListRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importWorkingPlanResult")
    public ImportResult importWorkingPlan(
        @WebParam(name = "importWorkingPlanRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "importWorkingPlanRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.services.ExportWorkingPlanResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingPlan")
    @WebResult(name = "exportWorkingPlanResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportWorkingPlanResult")
    public ExportWorkingPlanResult exportWorkingPlan(
        @WebParam(name = "exportWorkingPlanRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportWorkingPlanRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/", partName = "importCompletedWorksResult")
    public ImportResult importCompletedWorks(
        @WebParam(name = "importCompletedWorksRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "importCompletedWorksRequest")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.services.ExportCompletedWorksResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportCompletedWorks")
    @WebResult(name = "exportCompletedWorksResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportCompletedWorksResult")
    public ExportCompletedWorksResult exportCompletedWorks(
        @WebParam(name = "exportCompletedWorksRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "exportCompletedWorksRequest")
