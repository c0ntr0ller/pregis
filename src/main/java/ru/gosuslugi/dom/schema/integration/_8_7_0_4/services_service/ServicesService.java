 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-organization-service/services/Organization")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service/", "ServicesService");
    ...
    public ServicesPortsType getDefaultPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service/", "defaultPort"), ServicesPortsType.class);
    }
    ...
    public ServicesPortsType getDefaultPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service/", "defaultPort"), ServicesPortsType.class, features);
    }
