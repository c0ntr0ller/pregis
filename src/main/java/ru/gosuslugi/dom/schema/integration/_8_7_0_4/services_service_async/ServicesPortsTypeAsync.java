...
package ru.gosuslugi.dom.schema.integration._8_7_0_4.services_service_async;
...
import ru.gosuslugi.dom.schema.integration._8_7_0_4.services.GetStateResult;
 ...
 * 
 */
@WebService(name = "ServicesPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services-service-async/")
...
public interface ServicesPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration._8_7_0_4.services.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.4/services/", partName = "getStateResult")
