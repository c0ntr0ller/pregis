...
import ru.gosuslugi.dom.schema.integration._8_7_0.ID;
    ...
    extends FIOType
{
    ...
    @XmlElement(name = "SNILS", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/")
    protected String snils;
    @XmlElement(name = "ID", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/")
    protected ID id;
