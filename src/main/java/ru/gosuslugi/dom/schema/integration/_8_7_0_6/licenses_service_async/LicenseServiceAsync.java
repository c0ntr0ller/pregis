 ...
 * 
 */
@WebServiceClient(name = "LicenseServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/licenses-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-licenses-service/services/LicensesAsync")
    ...
    extends Service
{
    ...
    private final static QName LICENSESERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/licenses-service-async/", "LicenseServiceAsync");
    ...
    public LicensePortsTypeAsync getLicensesPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/licenses-service-async/", "LicensesPortAsync"), LicensePortsTypeAsync.class);
    }
    ...
    public LicensePortsTypeAsync getLicensesPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/licenses-service-async/", "LicensesPortAsync"), LicensePortsTypeAsync.class, features);
    }
