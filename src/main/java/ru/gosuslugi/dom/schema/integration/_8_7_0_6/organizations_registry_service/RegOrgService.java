 ...
 * 
 */
@WebServiceClient(name = "RegOrgService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/organizations-registry-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-org-registry-service/services/OrgRegistry")
    ...
    extends Service
{
    ...
    private final static QName REGORGSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/organizations-registry-service/", "RegOrgService");
    ...
    public RegOrgPortsType getRegOrgPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/organizations-registry-service/", "RegOrgPort"), RegOrgPortsType.class);
    }
    ...
    public RegOrgPortsType getRegOrgPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/organizations-registry-service/", "RegOrgPort"), RegOrgPortsType.class, features);
    }
