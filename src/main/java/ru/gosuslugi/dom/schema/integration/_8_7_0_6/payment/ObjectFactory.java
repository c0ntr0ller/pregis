 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_7_0_6.payment package. 
...
public class ObjectFactory {
    ...
    private final static QName _PDServiceName_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/payment/", "PDServiceName");
    private final static QName _Purpose_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/payment/", "Purpose");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_7_0_6.payment
     * 
     */
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration._8_7_0_6.payment.ExportPaymentDocumentDetailsResult }
     * 
     */
    public ru.gosuslugi.dom.schema.integration._8_7_0_6.payment.ExportPaymentDocumentDetailsResult createExportPaymentDocumentDetailsResult() {
        return new ru.gosuslugi.dom.schema.integration._8_7_0_6.payment.ExportPaymentDocumentDetailsResult();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/payment/", name = "PDServiceName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/payment/", name = "Purpose")
