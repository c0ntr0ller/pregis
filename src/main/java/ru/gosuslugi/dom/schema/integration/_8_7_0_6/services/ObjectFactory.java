 ...
 * generated in the ru.gosuslugi.dom.schema.integration._8_7_0_6.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _WorkListStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/services/", "WorkListStatus");
    private final static QName _HMServicesTarifsDocTypeKUMServiceTypeName_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.6/services/", "Name");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration._8_7_0_6.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/services/", name = "WorkListStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.6/services/", name = "Name", scope = HMServicesTarifsDocType.KU.MServiceType.class)
