...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.base.ElectricMeteringValueKindType.CurrentValue.class,
    ru.gosuslugi.dom.schema.integration.base.ElectricMeteringValueKindType.ControlValue.class,
    ru.gosuslugi.dom.schema.integration.services.device_metering.ImportMeteringDeviceValuesRequest.MeteringDevicesValues.ElectricDeviceValue.CurrentValue.class,
    ru.gosuslugi.dom.schema.integration.services.device_metering.ImportMeteringDeviceValuesRequest.MeteringDevicesValues.ElectricDeviceValue.ControlValue.class
})
