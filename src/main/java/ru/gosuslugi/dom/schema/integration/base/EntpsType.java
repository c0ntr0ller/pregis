...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.licenses.DisqualifiedPersonType.Org.Entrp.class,
    ru.gosuslugi.dom.schema.integration.services.licenses.LicenseOrganizationType.Entrp.class
})
