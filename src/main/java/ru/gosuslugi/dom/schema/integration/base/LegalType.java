 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}ShortName" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}FullName"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}CommercialName" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}OGRN"/>
 *         &lt;element name="StateRegistrationDate" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}INN" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}KPP" minOccurs="0"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}OKOPF" minOccurs="0"/>
 *         &lt;element name="Address" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="FIASHouseGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}FIASHouseGUIDType" minOccurs="0"/>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.licenses.DisqualifiedPersonType.Org.Legal.class,
    ru.gosuslugi.dom.schema.integration.services.licenses.LicenseOrganizationType.Legal.class,
    ru.gosuslugi.dom.schema.integration.services.licenses.LicenseType.LicensingAuthority.class,
    ru.gosuslugi.dom.schema.integration.services.licenses.CorrectLicenseType.LicensingAuthority.class,
    ru.gosuslugi.dom.schema.integration.services.licenses.AccompanyingDocumentType.Document.DecisionOrg.class
})
