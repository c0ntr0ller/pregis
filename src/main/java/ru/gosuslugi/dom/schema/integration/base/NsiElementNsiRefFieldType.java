 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}NsiElementFieldType">
 *       &lt;sequence>
 ...
 *                 &lt;sequence>
 *                   &lt;element name="NsiItemRegistryNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}NsiItemRegistryNumberType"/>
 *                   &lt;element name="Ref" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}nsiRef"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends NsiElementFieldType
{
    ...
    public static class NsiRef {
        ...
        protected ru.gosuslugi.dom.schema.integration.base.NsiRef ref;
         ...
         * @return
         *     possible object is
         *     {@link ru.gosuslugi.dom.schema.integration.base.NsiRef }
         *     
         */
        public ru.gosuslugi.dom.schema.integration.base.NsiRef getRef() {
            return ref;
        }
         ...
         *     
         */
        public void setRef(ru.gosuslugi.dom.schema.integration.base.NsiRef value) {
            this.ref = value;
        }
