...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.base.OneRateMeteringValueKindType.CurrentValue.class,
    ru.gosuslugi.dom.schema.integration.base.OneRateMeteringValueKindType.ControlValue.class,
    ru.gosuslugi.dom.schema.integration.services.device_metering.ImportMeteringDeviceValuesRequest.MeteringDevicesValues.OneRateDeviceValue.CurrentValue.class,
    ru.gosuslugi.dom.schema.integration.services.device_metering.ImportMeteringDeviceValuesRequest.MeteringDevicesValues.OneRateDeviceValue.ControlValue.class
})
