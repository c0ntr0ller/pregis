 ...
 *       &lt;sequence>
 *         &lt;element name="RecipientINN" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}INNType"/>
 *         &lt;element name="RecipientKPP" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}KPPType" minOccurs="0"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="BankBIK" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}BIKType"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="CorrespondentBankAccount" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}AccountType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.payment.ServiceDetailsType.ExecutorInformation.PaymentInformation.class,
    ru.gosuslugi.dom.schema.integration.services.payment.PaymentDocumentDetailsType.ExecutorInformation.PaymentInformation.class
})
