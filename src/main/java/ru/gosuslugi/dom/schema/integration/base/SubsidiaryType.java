 ...
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}OKOPF"/>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.base.SubsidiaryImportType.CreateSubsidiary.class,
    ru.gosuslugi.dom.schema.integration.services.organizations_registry_common.ExportOrgRegistryResultType.OrgVersion.Subsidiary.class
})
