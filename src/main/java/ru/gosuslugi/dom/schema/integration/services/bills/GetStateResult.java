 ...
 *         &lt;element name="exportOrgPeriodResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/}exportOrgPeriodResultType" maxOccurs="2"/>
 *         &lt;element name="exportPaymentDocResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/}exportPaymentDocumentResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportNotificationsOfOrderExecutionResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/}exportNotificationsOfOrderExecutionResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
