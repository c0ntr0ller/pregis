 ...
 * generated in the ru.gosuslugi.dom.schema.integration.services.bills package.
...
public class ObjectFactory {
    ...
    private final static QName _ServiceCharge_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/", "ServiceCharge");
    private final static QName _PaymentPeriodStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/", "PaymentPeriodStatus");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration.services.bills
     * 
     */
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration.services.bills.PaymentRecalculation }
     * 
     */
    public ru.gosuslugi.dom.schema.integration.services.bills.PaymentRecalculation createPaymentRecalculation() {
        return new ru.gosuslugi.dom.schema.integration.services.bills.PaymentRecalculation();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/", name = "ServiceCharge")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/", name = "PaymentPeriodStatus")
