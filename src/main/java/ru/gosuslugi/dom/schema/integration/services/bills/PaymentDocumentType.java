 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}AccountGuid"/>
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/}PDServiceChargeType">
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.bills.ExportPaymentDocumentResultType.PaymentDocument.class,
    ru.gosuslugi.dom.schema.integration.services.bills.ImportPaymentDocumentRequest.PaymentDocument.class
})
public class PaymentDocumentType {

    @XmlElement(name = "AccountGuid", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
