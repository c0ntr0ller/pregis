 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="MoneyDiscount" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}MoneyPositiveType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.bills.PDServiceChargeType.AdditionalServiceExt.class
})
