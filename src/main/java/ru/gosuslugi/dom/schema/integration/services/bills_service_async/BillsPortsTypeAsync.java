...
package ru.gosuslugi.dom.schema.integration.services.bills_service_async;
...
import ru.gosuslugi.dom.schema.integration.services.bills.GetStateResult;
 ...
 * 
 */
@WebService(name = "BillsPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills-service-async/")
...
public interface BillsPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.bills.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills/", partName = "getStateResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "openOrgPaymentPeriodResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "closeHousePaymentPeriodResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importPaymentDocumentDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "exportPaymentDocumentDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "exportOrgPeriodDataResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "exportNotificationsOfOrderExecutionResult")
    ...
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importAcknowledgmentResult")
