 ...
 * 
 */
@WebServiceClient(name = "BillsServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-bills-service/services/BillsAsync")
    ...
    extends Service
{
    ...
    private final static QName BILLSSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills-service-async/", "BillsServiceAsync");
    ...
    public BillsPortsTypeAsync getBillsPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills-service-async/", "BillsPortAsync"), BillsPortsTypeAsync.class);
    }
    ...
    public BillsPortsTypeAsync getBillsPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/bills-service-async/", "BillsPortAsync"), BillsPortsTypeAsync.class, features);
    }
