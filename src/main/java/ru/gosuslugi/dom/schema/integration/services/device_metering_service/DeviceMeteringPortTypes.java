...
package ru.gosuslugi.dom.schema.integration.services.device_metering_service;
 ...
 * 
 */
@WebService(name = "DeviceMeteringPortTypes", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service/")
...
public interface DeviceMeteringPortTypes {
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "ImportResult")
    public ImportResult importMeteringDeviceValues(
        @WebParam(name = "importMeteringDeviceValuesRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering/", partName = "importMeteringDeviceValuesRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.device_metering.ExportMeteringDeviceHistoryResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportMeteringDeviceHistory")
    @WebResult(name = "exportMeteringDeviceHistoryResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering/", partName = "exportMeteringDeviceHistoryResult")
    public ExportMeteringDeviceHistoryResult exportMeteringDeviceHistory(
        @WebParam(name = "exportMeteringDeviceHistoryRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering/", partName = "exportMeteringDeviceHistoryRequest")
