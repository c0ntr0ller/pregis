...
package ru.gosuslugi.dom.schema.integration.services.device_metering_service_async;
...
import ru.gosuslugi.dom.schema.integration.services.device_metering.GetStateResult;
 ...
 * 
 */
@WebService(name = "DeviceMeteringPortTypesAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service-async/")
...
public interface DeviceMeteringPortTypesAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.device_metering.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering/", partName = "getStateResult")
