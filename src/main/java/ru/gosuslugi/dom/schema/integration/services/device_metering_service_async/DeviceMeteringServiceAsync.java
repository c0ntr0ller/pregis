 ...
 * 
 */
@WebServiceClient(name = "DeviceMeteringServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-device-metering-service/services/DeviceMeteringAsync")
    ...
    extends Service
{
    ...
    private final static QName DEVICEMETERINGSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service-async/", "DeviceMeteringServiceAsync");
    ...
    public DeviceMeteringPortTypesAsync getDeviceMeteringPortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service-async/", "DeviceMeteringPortAsync"), DeviceMeteringPortTypesAsync.class);
    }
    ...
    public DeviceMeteringPortTypesAsync getDeviceMeteringPortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/device-metering-service-async/", "DeviceMeteringPortAsync"), DeviceMeteringPortTypesAsync.class, features);
    }
