 ...
 *       &lt;sequence>
 *         &lt;element name="BasicCharacteristicts" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}HouseBasicUpdateUOType"/>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.house_management.ImportHouseUORequest.ApartmentHouse.ApartmentHouseToUpdate.class
})
