 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}AccountType">
 *       &lt;sequence>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}AccountNumber"/>
 *         &lt;element name="AccountGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}AccountUniqueNumber"/>
    ...
    extends AccountType
{
    ...
    @XmlElement(name = "AccountNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
    protected String accountNumber;
    @XmlElement(name = "AccountGUID", required = true)
    protected String accountGUID;
    @XmlElement(name = "AccountUniqueNumber", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
