 ...
 *         &lt;/element>
 *         &lt;choice>
 *           &lt;element name="AppartmentHouseAcceptedParameter" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}ApartmentHouseAcceptedParameterType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="LivingHouseAcceptedParameter" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}LivingHouseAcceptedParameterType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="NonResidentialPremiseAcceptedParameter" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}NonResidentialPremiseAcceptedParameterType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="ResidentialPremiseAcceptedParameter" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}ResidentialPremiseAcceptedParameterType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="RoomAcceptedParameter" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}RoomAcceptedParameterType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.house_management.OGFImportStatusType.GKNRelationshipStatus.class
})
