 ...
 *         &lt;element name="TotalSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}TotalSquareType"/>
 *         &lt;element name="State" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}nsiRef"/>
 *         &lt;element name="UsedYear" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}UsedYearType"/>
 *         &lt;element name="FloorCount" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}FloorType"/>
 *         &lt;element name="OKTMO" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}OKTMORefType" minOccurs="0"/>
 *         &lt;element name="OlsonTZ" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}nsiRef"/>
 *         &lt;element name="ResidentialSquare" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/}ResidentialSquareType"/>
