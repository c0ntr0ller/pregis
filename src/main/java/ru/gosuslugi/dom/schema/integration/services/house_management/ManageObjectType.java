...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.house_management.CharterType.ContractObjectList.ContractObject.class,
    ru.gosuslugi.dom.schema.integration.services.house_management.ContractType.ContractObject.class
})
