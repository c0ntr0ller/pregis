...
public interface HouseManagementPortsType {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult
     * @throws Fault
     */
    @WebMethod(action = "urn:importMeteringDeviceData")
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "importMeteringDeviceDataResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importMeteringDeviceData(
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportMeteringDeviceDataResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportMeteringDeviceData")
    @WebResult(name = "exportMeteringDeviceDataResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportMeteringDeviceDataResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "importResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importContractData(
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "ImportResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importCharterData(
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportStatusCAChResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportStatusCAChData")
    @WebResult(name = "exportStatusCAChResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportStatusCAChResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportHouseResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportHouseData")
    @WebResult(name = "exportHouseResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportHouseDataResult")
    public ExportHouseResult exportHouseData(
        @WebParam(name = "exportHouseRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportHouseDataRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importAccountDataResult")
    public ru.gosuslugi.dom.schema.integration.base.ImportResult importAccountData(
        @WebParam(name = "importAccountRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "importAccountDataRequest")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportAccountResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportAccountData")
    @WebResult(name = "exportAccountResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportAccountDataResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importPublicPropertyContractResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportStatusPublicPropertyContractResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportStatusPublicPropertyContract")
    @WebResult(name = "exportStatusPublicPropertyContractResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportStatusPublicPropertyContractResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importNotificationResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importVotingProtocolResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportVotingProtocolResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportVotingProtocol")
    @WebResult(name = "exportVotingProtocolResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportVotingProtocolResult")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportCAChResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportCAChData")
    @WebResult(name = "exportCAChResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportCAChDataResult")
    public ExportCAChResult exportCAChData(
        @WebParam(name = "exportCAChRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportCAChDataRequest")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "ImportResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importHouseUOData(
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "ImportResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importHouseRSOData(
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "ImportResult")
    public ru.gosuslugi.dom.schema.integration.services.house_management.ImportResult importHouseOMSData(
        ...
        @WebParam(name = "RequestHeader", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", header = true, mode = WebParam.Mode.INOUT, partName = "Header")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importSupplyResourceContractResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.house_management.ExportSupplyResourceContractResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportSupplyResourceContractData")
    @WebResult(name = "exportSupplyResourceContractResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management/", partName = "exportSupplyResourceContractResult")
