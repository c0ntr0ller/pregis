    ...
    extends Service
{
    ...
    private final static QName HOUSEMANAGEMENTSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management-service/", "HouseManagementService");
    ...
    public HouseManagementPortsType getHouseManagementPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management-service/", "HouseManagementPort"), HouseManagementPortsType.class);
    }
    ...
    public HouseManagementPortsType getHouseManagementPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/house-management-service/", "HouseManagementPort"), HouseManagementPortsType.class, features);
    }
