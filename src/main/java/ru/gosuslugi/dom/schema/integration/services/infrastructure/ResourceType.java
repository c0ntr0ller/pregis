 ...
 *         &lt;element name="TotalLoad" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure/}PowerType" minOccurs="0"/>
 *         &lt;element name="IndustrialLoad" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure/}PowerType" minOccurs="0"/>
 *         &lt;element name="SocialLoad" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure/}PowerType" minOccurs="0"/>
 *         &lt;element name="PopulationLoad" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure/}PowerType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.infrastructure.InfrastructureType.ObjectProperty.Resources.class,
    ru.gosuslugi.dom.schema.integration.services.infrastructure.InfrastructureType.ObjectProperty.TransportationResources.class
})
