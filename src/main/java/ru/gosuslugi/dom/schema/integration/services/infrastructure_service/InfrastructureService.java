 ...
 * 
 */
@WebServiceClient(name = "InfrastructureService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-rki-service/services/Infrastructure")
    ...
    extends Service
{
    ...
    private final static QName INFRASTRUCTURESERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service/", "InfrastructureService");
    ...
    public InfrastructurePortsType getInfrastructurePort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service/", "InfrastructurePort"), InfrastructurePortsType.class);
    }
    ...
    public InfrastructurePortsType getInfrastructurePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service/", "InfrastructurePort"), InfrastructurePortsType.class, features);
    }
