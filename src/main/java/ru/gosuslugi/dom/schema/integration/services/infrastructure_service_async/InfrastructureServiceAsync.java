 ...
 * 
 */
@WebServiceClient(name = "InfrastructureServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service-async/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-rki-service/services/InfrastructureAsync")
    ...
    extends Service
{
    ...
    private final static QName INFRASTRUCTURESERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service-async/", "InfrastructureServiceAsync");
    ...
    public InfrastructurePortsTypeAsync getInfrastructurePortAsync() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service-async/", "InfrastructurePortAsync"), InfrastructurePortsTypeAsync.class);
    }
    ...
    public InfrastructurePortsTypeAsync getInfrastructurePortAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/infrastructure-service-async/", "InfrastructurePortAsync"), InfrastructurePortsTypeAsync.class, features);
    }
