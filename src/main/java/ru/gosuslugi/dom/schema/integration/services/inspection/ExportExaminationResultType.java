 ...
 *       &lt;sequence>
 *         &lt;element name="ExaminationGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType"/>
 *         &lt;element name="RegistryNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}String255Type" minOccurs="0"/>
 *         &lt;element name="ExaminationState" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}ExaminationStateType"/>
 *         &lt;element name="ExaminationVersionState" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}ExaminationVersionStateType"/>
 *         &lt;element name="Examination" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}ExaminationType"/>
 *         &lt;element name="ExportPrecept" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="PreceptGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType"/>
 *                   &lt;element name="PreceptState" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}PreceptStateType"/>
 *                   &lt;element name="Precept" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}PreceptType"/>
 *                   &lt;element name="CancelledInfo" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}CancelledInfoWithAttachmentsType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="OffenceGuid" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType"/>
 *                   &lt;element name="OffenceState" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}OffenceStateType"/>
 *                   &lt;element name="Offence" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}OffenceType"/>
 *                   &lt;element name="CancelledInfo" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}CancelledInfoWithAttachmentsType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
