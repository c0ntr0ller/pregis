 ...
 *         &lt;element name="CommonResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}CommonResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportInspectionPlanResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}exportInspectionPlanResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportExaminationResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/inspection/}exportExaminationResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
