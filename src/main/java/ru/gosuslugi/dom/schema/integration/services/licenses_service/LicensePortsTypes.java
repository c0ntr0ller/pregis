...
package ru.gosuslugi.dom.schema.integration.services.licenses_service;
 ...
 * 
 */
@WebService(name = "LicensePortsTypes", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/licenses-service/")
...
public interface LicensePortsTypes {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.licenses.ExportLicenseResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportLicense")
    @WebResult(name = "exportLicenseResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/licenses/", partName = "exportLicenseResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.licenses.ExportDisqualifiedPersonResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportDisqualifiedPerson")
    @WebResult(name = "exportDisqualifiedPersonResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/licenses/", partName = "exportDisqualifiedPersonResultType")
