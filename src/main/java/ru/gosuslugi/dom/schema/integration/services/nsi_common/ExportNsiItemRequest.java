 ...
 *       &lt;sequence>
 *         &lt;element name="RegistryNumber" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}NsiItemRegistryNumberType"/>
 *         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}ListGroup"/>
    ...
    extends BaseType
{
    ...
    @XmlElement(name = "ListGroup", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
