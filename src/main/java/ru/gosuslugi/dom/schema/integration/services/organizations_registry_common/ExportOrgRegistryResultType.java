...
package ru.gosuslugi.dom.schema.integration.services.organizations_registry_common;
...
import ru.gosuslugi.dom.schema.integration.base.EntpsType;
import ru.gosuslugi.dom.schema.integration.base.LegalType;
import ru.gosuslugi.dom.schema.integration.base.NsiRef;
import ru.gosuslugi.dom.schema.integration.base.RegOrgVersionType;
import ru.gosuslugi.dom.schema.integration.base.SubsidiaryType;
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}orgVersionGUID"/>
 ...
 *                   &lt;choice>
 *                     &lt;element name="Legal" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}LegalType"/>
 *                     &lt;element name="Subsidiary">
 *                       &lt;complexType>
 *                         &lt;complexContent>
 *                           &lt;extension base="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}SubsidiaryType">
 *                             &lt;sequence>
 ...
 *                                     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                       &lt;sequence>
 *                                         &lt;element ref="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}RegOrgVersion"/>
 *                                       &lt;/sequence>
 *                                     &lt;/restriction>
 *                                   &lt;/complexContent>
 *                                 &lt;/complexType>
 ...
 *                       &lt;/complexType>
 *                     &lt;/element>
 *                     &lt;element name="Entrp" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}EntpsType"/>
 *                   &lt;/choice>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="organizationRoles" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}nsiRef" maxOccurs="unbounded" minOccurs="0"/>
...
public class ExportOrgRegistryResultType {
    ...
    @XmlElement(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
    ...
    public static class OrgVersion {
            ...
            extends SubsidiaryType
        {
            ...
            public static class ParentOrg {
                ...
                @XmlElement(name = "RegOrgVersion", namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", required = true)
