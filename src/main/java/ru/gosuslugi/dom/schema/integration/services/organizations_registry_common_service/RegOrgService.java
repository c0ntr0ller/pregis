 ...
 * 
 */
@WebServiceClient(name = "RegOrgService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common-service/", wsdlLocation = "https://54.76.42.99:60045/ext-bus-org-registry-common-service/services/OrgRegistryCommon")
    ...
    extends Service
{
    ...
    private final static QName REGORGSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common-service/", "RegOrgService");
    ...
    public RegOrgPortsType getRegOrgPort() {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common-service/", "RegOrgPort"), RegOrgPortsType.class);
    }
    ...
    public RegOrgPortsType getRegOrgPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common-service/", "RegOrgPort"), RegOrgPortsType.class, features);
    }
