...
package ru.gosuslugi.dom.schema.integration.services.organizations_registry_common_service_async;
...
import ru.gosuslugi.dom.schema.integration.services.organizations_registry_common.GetStateResult;
 ...
 * 
 */
@WebService(name = "RegOrgPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common-service-async/")
...
public interface RegOrgPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.organizations_registry_common.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-common/", partName = "getStateResult")
