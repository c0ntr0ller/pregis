...
import ru.gosuslugi.dom.schema.integration.services.organizations_registry.GetStateResult;
 ...
 * 
 */
@WebService(name = "RegOrgPortsTypeAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry-service-async/")
...
public interface RegOrgPortsTypeAsync {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.organizations_registry.GetStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getState")
    @WebResult(name = "getStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/organizations-registry/", partName = "getStateResult")
