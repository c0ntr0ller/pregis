 ...
 * generated in the ru.gosuslugi.dom.schema.integration.services.payment package.
...
public class ObjectFactory {
    ...
    private final static QName _Purpose_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/payment/", "Purpose");
    private final static QName _PDServiceName_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/payment/", "PDServiceName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration.services.payment
     * 
     */
    ...
    /**
     * Create an instance of {@link ru.gosuslugi.dom.schema.integration.services.payment.ExportPaymentDocumentDetailsResult }
     * 
     */
    public ru.gosuslugi.dom.schema.integration.services.payment.ExportPaymentDocumentDetailsResult createExportPaymentDocumentDetailsResult() {
        return new ru.gosuslugi.dom.schema.integration.services.payment.ExportPaymentDocumentDetailsResult();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/payment/", name = "Purpose")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/payment/", name = "PDServiceName")
