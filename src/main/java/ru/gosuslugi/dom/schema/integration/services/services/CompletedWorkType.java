 ...
 *       &lt;sequence>
 *         &lt;element name="photos" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}AttachmentType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;/element>
 *         &lt;choice>
 *           &lt;element name="ActTransportGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType" minOccurs="0"/>
 *           &lt;element name="ActGUID" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}GUIDType" minOccurs="0"/>
 *         &lt;/choice>
 *         &lt;element name="TotalCost" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/}WorkCostType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.services.services.CompletedWorksByPeriodType.PlannedWork.class,
    ru.gosuslugi.dom.schema.integration.services.services.CompletedWorksByPeriodType.UnplannedWork.class,
    ru.gosuslugi.dom.schema.integration.services.services.CompletedWorksByPeriodExportType.UnplannedWork.class
})
