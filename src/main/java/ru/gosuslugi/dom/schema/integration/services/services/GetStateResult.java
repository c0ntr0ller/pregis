 ...
 *         &lt;element name="ImportResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/}CommonResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportHMServicesTarifsResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/}exportHMServicesTarifsResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportCompletedWorksResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/}exportCompletedWorksResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportWorkingListResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/}exportWorkingListResultType" maxOccurs="unbounded"/>
 *         &lt;element name="exportWorkingPlanResult" type="{http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/}exportWorkingPlanResultType" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
