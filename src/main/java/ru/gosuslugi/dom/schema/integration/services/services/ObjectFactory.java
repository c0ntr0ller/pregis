 ...
 * generated in the ru.gosuslugi.dom.schema.integration.services.services package.
...
public class ObjectFactory {
    ...
    private final static QName _WorkListStatus_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", "WorkListStatus");
    private final static QName _HMServicesTarifsDocTypeKUMServiceTypeName_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", "Name");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.gosuslugi.dom.schema.integration.services.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", name = "WorkListStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", name = "Name", scope = HMServicesTarifsDocType.KU.MServiceType.class)
