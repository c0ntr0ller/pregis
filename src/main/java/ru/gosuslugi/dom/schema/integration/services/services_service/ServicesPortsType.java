...
package ru.gosuslugi.dom.schema.integration.services.services_service;
...
import ru.gosuslugi.dom.schema.integration.services.services.ExportCompletedWorksResult;
import ru.gosuslugi.dom.schema.integration.services.services.ExportHMServicesTarifsRequest;
import ru.gosuslugi.dom.schema.integration.services.services.ExportHMServicesTarifsResult;
import ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingListRequest;
import ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingListResult;
import ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingPlanRequest;
import ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingPlanResult;
 ...
 * 
 */
@WebService(name = "ServicesPortsType", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services-service/")
...
public interface ServicesPortsType {
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.services.ExportHMServicesTarifsResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportHMServicesTarifs")
    @WebResult(name = "exportHMServicesTarifsResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", partName = "exportHMServicesTarifsDataResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingListResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingList")
    @WebResult(name = "exportWorkingListResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", partName = "exportWorkingListResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importWorkingListResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importWorkingPlanResult")
     ...
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.services.ExportWorkingPlanResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportWorkingPlan")
    @WebResult(name = "exportWorkingPlanResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", partName = "exportWorkingPlanResult")
    ...
    @WebResult(name = "ImportResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/", partName = "importCompletedWorksResult")
     ...
     * @param header
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.services.services.ExportCompletedWorksResult
     * @throws Fault
     */
    @WebMethod(action = "urn:exportCompletedWorks")
    @WebResult(name = "exportCompletedWorksResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/8.7.0.7/services/", partName = "exportCompletedWorksResult")
