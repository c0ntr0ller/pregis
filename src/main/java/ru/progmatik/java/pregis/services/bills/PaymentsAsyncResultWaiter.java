 ...
 */
public class PaymentsAsyncResultWaiter {
    private final AckRequest ackRequest;
    private static final Logger LOGGER = Logger.getLogger(PaymentsAsyncResultWaiter.class);
    ...
    public PaymentsAsyncResultWaiter(AckRequest ackRequest, String name_method, AnswerProcessing answerProcessing, BillsPortsTypeAsync port) {
