...
public class ExportNsiItemAsyncResultWaiter {
    private final AckRequest ackRequest;
    private static final Logger LOGGER = Logger.getLogger(ExportNsiItemAsyncResultWaiter.class);
    ...
    public ExportNsiItemAsyncResultWaiter(AckRequest ackRequest, String name_method, AnswerProcessing answerProcessing, NsiPortsTypeAsync port) {
