 ...
 */
package ru.progmatik.java.pregis.signet.bcsign.security.algorithms;
...
abstract class SignatureGostR34102001 extends SignatureAlgorithmSpi {
	...
	private static final Logger LOGGER = Logger.getLogger(SignatureGostR34102001.class);
	...
	protected boolean engineVerify(byte[] signature) throws XMLSignatureException {
		...
		try {
			if (LOGGER.isDebugEnabled())
				LOGGER.debug("Called gostr34102001-gostr3411.verify() on " + Base64.encode(signature));
	...
	protected void engineInitVerify(Key publicKey) throws XMLSignatureException {
		...
		try {
			...
			try {
				...
				// Signature
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Exception when reinstantiating Signature:" + e);
				}
